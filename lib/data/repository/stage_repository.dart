...
class StageRepository {
  ...
  static const List<StageItem> _database = [
    ...
    StageItem(alias: 'UnchartedIceageStage', name: '冰河再临', iconName: 'Stage_CLYSE.webp', type: StageType.extra),
    ...
    StageItem(alias: 'OverwhelmStage', name: '排山倒海', iconName: 'Stage_FBCR.webp', type: StageType.special),
