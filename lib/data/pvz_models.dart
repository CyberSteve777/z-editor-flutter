...
// === Bronze (Kongfu World bronze statues / 铜人阵) ===
...
/// One revival wave: bronzes with the same timing may appear in one batch.
class BronzeStatueBatchData {
  ...
  factory BronzeStatueBatchData.fromJson(Map<String, dynamic> json) {
    ...
    return BronzeStatueBatchData(
      itemList: list
              ?.map((e) =>
                  BronzeStatueItemData.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );
  }
...
// === PVZ1 Copycats (Guess who I am / magic hat) ===

class PVZ1CopycatsModulePropertiesData {
  ...
  factory PVZ1CopycatsModulePropertiesData.fromJson(Map<String, dynamic> json) {
    ...
    return PVZ1CopycatsModulePropertiesData(
      ...
      spawnPlantLevel: spl is int
          ? spl
          : (spl is num ? spl.toInt() : 5),
      plantBlackList: pbl is List
          ? pbl.map((e) => '$e').toList()
          : <String>[],
      zombieWhiteList: zwl is List
          ? zwl.map((e) => '$e').toList()
          : <String>[],
    );
  }
